...
module.exports = function (svgString) {
    ...
    recast.types.visit(ast, {
        visitJSXAttribute: function visitJSXAttribute(path) {
        ...
        visitJSXIdentifier: function visitJSXIdentifier(path) {
    ...
    ast = importReactStatement(makeLastStatementExport(wrapAstInFunction('SvgIcon', makeLastStatementReturn(ast))));
